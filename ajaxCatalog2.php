<div data-row="15" class="content_margin_rel game_brick left_side onehalf_size">
...
<div data-row="17" data-color="1" class="content_margin_rel game_brick right_side right_info info_brick">
	<div class="bg_color_wrapper"><h3>New<br />Add-ons<br />available.</h3></div>
	<div class="sub_brick bg_images gamebrick_03"></div>
</div>
<div data-row="18" class="content_margin_rel game_brick left_side onehalf_size">
	<div class="sub_brick bg_images gamebrick_04"></div>
</div>
<div data-row="19" class="content_margin_rel game_brick right_side onehalf_size">
	<div class="sub_brick bg_images gamebrick_05"></div>
</div>
<div data-row="21" class="content_margin_rel game_brick left_side onehalf_size">
	<div class="sub_brick bg_images gamebrick_06"></div>
</div>
<div data-row="22" data-color="2" class="content_margin_rel game_brick right_side left_info info_brick">
	<div class="bg_color_wrapper"><h3>New<br />Add-ons<br />available<br />now.</h3></div>
	<div class="sub_brick bg_images gamebrick_07"></div>
</div>
<div data-row="24" data-color="3" class="content_margin_rel game_brick left_side right_info info_brick">
	<div class="bg_color_wrapper"><h3>3 new<br />empires<br />available<br />now.</h3></div>
	<div class="sub_brick bg_images gamebrick_08"></div>
</div>
<div data-row="24" class="content_margin_rel game_brick right_side onehalf_size">
	<div class="sub_brick bg_images gamebrick_09"></div>
</div>
<div data-row="26" data-color="4" class="content_margin_rel game_brick left_side left_info info_brick">
	<div class="bg_color_wrapper"><h3>Oh hey<br />buy this<br />game.</h3></div>
	<div class="sub_brick bg_images gamebrick_10"></div>
</div>
<div data-row="28" data-color="5" class="content_margin_rel game_brick left_side left_info info_brick">
	<div class="bg_color_wrapper"><h3>Feature<br />here!<br />Don\'t miss<br />this.</h3></div>
	<div class="sub_brick bg_images gamebrick_11"></div>
</div>
<div data-row="27" class="content_margin_rel game_brick right_side onehalf_size">
